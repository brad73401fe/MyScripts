...
FILE_NAME_HEADER=TOUCH_76_BE_V2P20.sh;
...
#	printf "Set_Touch_All_Flag = ${Set_Touch_All_Flag}\n";
	...
	CHECK_DIR_FILE[8]=logs;
	CHECK_DIR_FILE[9]=Mail;
	CHECK_DIR_FILE[10]=Music;
	CHECK_DIR_FILE[11]=Pictures;
	CHECK_DIR_FILE[12]=devices;
	CHECK_DIR_FILE[13]=devices/BBIC5;
	CHECK_DIR_FILE[14]=devices/BBIC6;
	CHECK_DIR_FILE[15]=devices/PMIC;
	CHECK_DIR_FILE[16]=projects;
	CHECK_DIR_FILE[17]=projects/proj_Advantest;
	CHECK_DIR_FILE[18]=projects/proj_AllianceATE;
	CHECK_DIR_FILE[19]=projects/proj_Atlantic;
	CHECK_DIR_FILE[20]=projects/proj_Bermuda;
	CHECK_DIR_FILE[21]=projects/proj_Europa;
	CHECK_DIR_FILE[22]=projects/proj_Fiji;
	CHECK_DIR_FILE[23]=projects/proj_GalaxyDB;
	CHECK_DIR_FILE[24]=projects/proj_Hak5;
	CHECK_DIR_FILE[25]=projects/proj_HTML;
	CHECK_DIR_FILE[26]=projects/proj_Jamaica;
	CHECK_DIR_FILE[27]=projects/proj_Python;
	CHECK_DIR_FILE[28]=projects/proj_QTNA;
	CHECK_DIR_FILE[29]=projects/proj_RaspberryPi;
	CHECK_DIR_FILE[30]=projects/proj_Sageville;
	CHECK_DIR_FILE[31]=projects/proj_VTRAN;
	CHECK_DIR_FILE[32]=projects/proj_Zelda;
	CHECK_DIR_FILE[33]=Public;
	CHECK_DIR_FILE[34]=smarTest;
	CHECK_DIR_FILE[35]=stdf;
	CHECK_DIR_FILE[36]=Templates;
	CHECK_DIR_FILE[37]=Videos;
	CHECK_DIR_FILE[38]=workorder;
	CHECK_DIR_FILE[39]=workspace;
	CHECK_DIR_FILE[40]=workspace/workspace_7.3.2.X_64bit_AQC100_BE;
	CHECK_DIR_FILE[41]=workspace/workspace_7.3.2.X_64bit_AQC107_BE;
	CHECK_DIR_FILE[42]=workspace/workspace_7.3.2.X_64bit_AQC111C_BE;
	CHECK_DIR_FILE[43]=workspace/workspace_7.3.2.X_64bit_BBIC5_BE;
	CHECK_DIR_FILE[44]=workspace/workspace_7.4.0.X_64bit_BBIC5_BE;
	CHECK_DIR_FILE[45]=workspace/workspace_7.4.2.X_64bit_BBIC5_BE;
	CHECK_DIR_FILE[46]=workspace/workspace_7.4.3.X_64bit_BBIC6_BE;
	CHECK_DIR_FILE[47]=workspace/workspace_7.5.2.X_64bit_BBIC6_BE;
	CHECK_DIR_FILE[48]=workspace/workspace_7.4.3.X_64bit_PMIC_BE;
	CHECK_DIR_FILE[49]=workspace/workspace_7.5.2.X_64bit_PMIC_BE;
	CHECK_DIR_FILE[50]=.device_inuse_soc;
	CHECK_DIR_FILE[51]=.device_inuse_soc.AQC100_DEV;
	CHECK_DIR_FILE[52]=.device_inuse_soc.AQC107_DEV;
	CHECK_DIR_FILE[53]=.device_inuse_soc.AQC111C_DEV;
	CHECK_DIR_FILE[54]=.device_inuse_soc.BBIC5_DEV;
	CHECK_DIR_FILE[55]=.device_inuse_soc.BBIC6_DEV;
	CHECK_DIR_FILE[56]=.device_inuse_soc.PMIC_DEV;
	CHECK_DIR_FILE[57]=.device_inuse_soc.RFIC_DEV;
	CHECK_DIR_FILE[58]=.device_inuse_soc@$HOSTNAME;
	CHECK_DIR_FILE[59]=.bash_aliases;
	CHECK_DIR_FILE[60]=.bash_logout;
	CHECK_DIR_FILE[61]=.bash_profile;
	CHECK_DIR_FILE[62]=.bashrc;
	CHECK_DIR_FILE[63]=.login;
	CHECK_DIR_FILE[64]=.profile;
	CHECK_DIR_FILE[65]=.tcshrc;
	CHECK_DIR_FILE[66]=MAKE_APT_GET_COMMAND_V2P19.sh;
	CHECK_DIR_FILE[67]=${FILE_NAME_HEADER};
	CHECK_DIR_FILE[68]=${FILE_NAME_HEADER//.sh/.py};
	
	#printf "\nTotal %s = %d\n\n" "CHECK_DIR_FILE" ${#CHECK_DIR_FILE[@]};   #DEBUG ONLY. REMOVE WHEN FINISHED.
	
	#### Set the for-loop stop variable. ####
	LoopBeg=$(( 0 ));                                                       #Minimum value = 0;
	LoopEnd=$(( ${#CHECK_DIR_FILE[@]} ));                                   #Maximum value = 69;
