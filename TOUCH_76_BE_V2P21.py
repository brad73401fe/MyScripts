...
FILE_NAME_HEADER="TOUCH_76_BE_V2P21.py";
...
if (Set_Touch_All_Flag == 1 ) and (USER == VALID_USER):
	...
	CHECK_DIR_FILE.insert(8, "GIT_DIR");
	CHECK_DIR_FILE.insert(9, "logs");
	CHECK_DIR_FILE.insert(10, "Mail");
	CHECK_DIR_FILE.insert(11, "Music");
	CHECK_DIR_FILE.insert(12, "Pictures");
	CHECK_DIR_FILE.insert(13, "devices");
	CHECK_DIR_FILE.insert(14, "devices/BBIC5");
	CHECK_DIR_FILE.insert(15, "devices/BBIC6");
	CHECK_DIR_FILE.insert(16, "devices/PMIC");
	CHECK_DIR_FILE.insert(17, "projects");
	CHECK_DIR_FILE.insert(18, "projects/proj_Advantest");
	CHECK_DIR_FILE.insert(19, "projects/proj_AllianceATE");
	CHECK_DIR_FILE.insert(20, "projects/proj_Atlantic");
	CHECK_DIR_FILE.insert(21, "projects/proj_Bermuda");
	CHECK_DIR_FILE.insert(22, "projects/proj_Europa");
	CHECK_DIR_FILE.insert(23, "projects/proj_Fiji");
	CHECK_DIR_FILE.insert(24, "projects/proj_GalaxyDB");
	CHECK_DIR_FILE.insert(25, "projects/proj_Hak5");
	CHECK_DIR_FILE.insert(26, "projects/proj_HTML");
	CHECK_DIR_FILE.insert(27, "projects/proj_Jamaica");
	CHECK_DIR_FILE.insert(28, "projects/proj_Python");
	CHECK_DIR_FILE.insert(29, "projects/proj_QTNA");
	CHECK_DIR_FILE.insert(30, "projects/proj_RaspberryPi");
	CHECK_DIR_FILE.insert(31, "projects/proj_Sageville");
	CHECK_DIR_FILE.insert(32, "projects/proj_VTRAN");
	CHECK_DIR_FILE.insert(33, "projects/proj_Zelda");
	CHECK_DIR_FILE.insert(34, "Public");
	CHECK_DIR_FILE.insert(35, "smarTest");
	CHECK_DIR_FILE.insert(36, "stdf");
	CHECK_DIR_FILE.insert(37, "Templates");
	CHECK_DIR_FILE.insert(38, "Videos");
	CHECK_DIR_FILE.insert(39, "workorder");
	CHECK_DIR_FILE.insert(40, "workspace");
	CHECK_DIR_FILE.insert(41, "workspace/workspace_7.3.2.X_64bit_AQC100_BE");
	CHECK_DIR_FILE.insert(42, "workspace/workspace_7.3.2.X_64bit_AQC107_BE");
	CHECK_DIR_FILE.insert(43, "workspace/workspace_7.3.2.X_64bit_AQC111C_BE");
	CHECK_DIR_FILE.insert(44, "workspace/workspace_7.3.2.X_64bit_BBIC5_BE");
	CHECK_DIR_FILE.insert(45, "workspace/workspace_7.4.0.X_64bit_BBIC5_BE");
	CHECK_DIR_FILE.insert(46, "workspace/workspace_7.4.2.X_64bit_BBIC5_BE");
	CHECK_DIR_FILE.insert(47, "workspace/workspace_7.4.3.X_64bit_BBIC6_BE");
	CHECK_DIR_FILE.insert(48, "workspace/workspace_7.5.2.X_64bit_BBIC6_BE");
	CHECK_DIR_FILE.insert(49, "workspace/workspace_7.4.3.X_64bit_PMIC_BE");
	CHECK_DIR_FILE.insert(50, "workspace/workspace_7.5.2.X_64bit_PMIC_BE");
	CHECK_DIR_FILE.insert(51, ".device_inuse_soc");
	CHECK_DIR_FILE.insert(52, ".device_inuse_soc.AQC100_DEV");
	CHECK_DIR_FILE.insert(53, ".device_inuse_soc.AQC107_DEV");
	CHECK_DIR_FILE.insert(54, ".device_inuse_soc.AQC111C_DEV");
	CHECK_DIR_FILE.insert(55, ".device_inuse_soc.BBIC5_DEV");
	CHECK_DIR_FILE.insert(56, ".device_inuse_soc.BBIC6_DEV");
	CHECK_DIR_FILE.insert(57, ".device_inuse_soc.PMIC_DEV");
	CHECK_DIR_FILE.insert(58, ".device_inuse_soc.RFIC_DEV");
	CHECK_DIR_FILE.insert(59, ".device_inuse_soc@"+HOSTNAME);
	CHECK_DIR_FILE.insert(60, ".bash_aliases");
	CHECK_DIR_FILE.insert(61, ".bash_logout");
	CHECK_DIR_FILE.insert(62, ".bash_profile");
	CHECK_DIR_FILE.insert(63, ".bashrc");
	CHECK_DIR_FILE.insert(64, ".login");
	CHECK_DIR_FILE.insert(65, ".profile");
	CHECK_DIR_FILE.insert(66, ".tcshrc");
	CHECK_DIR_FILE.insert(67, "MAKE_APT_GET_COMMAND_V2P19.sh");
	CHECK_DIR_FILE.insert(68, FILE_NAME_HEADER.replace(".py", ".sh"));
	CHECK_DIR_FILE.insert(69, FILE_NAME_HEADER);
	...
	LoopEnd=(len(CHECK_DIR_FILE));                                          #Maximum value = 70;
